...
open class BasicField<T: Any>(type: KClass<T>, prefix: String, default: T, key: String, private val addEntry: BasicField<T>.(ConfigEntryBuilder, T) -> AbstractConfigListEntry<*>) : MutableState<T>(type, default), EntryView {
